...
/**
 * <p>
 * DefaultmisdnconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultmisdnconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:34 urs Exp $
 */
public class DefaultmisdnconfTreeDialog extends
     ...
     */
    public DefaultmisdnconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultmisdnconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultmisdnconfTreeDialog(Object data) {
        super(data);
        initTree(data);
