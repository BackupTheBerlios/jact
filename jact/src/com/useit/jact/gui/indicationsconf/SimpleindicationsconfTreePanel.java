...
/**
 * <p>
 * SimpleindicationsconfTreePanel , ein tree panel das eine Objekt grupppe des
 * Models mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimpleindicationsconfTreePanel.java,v 1.3
 *          2006/01/06 19:04:07 urs Exp $
 */
public class SimpleindicationsconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimpleindicationsconfTreePanel() throws HeadlessException {
        super();
    }
