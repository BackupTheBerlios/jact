...
import com.useit.jact.io.indicationsconf.ConfReaderImpl;
import com.useit.jact.io.indicationsconf.ConfWriterImpl;
import com.useit.jact.io.indicationsconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultindicationsconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultindicationsconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:42 urs Exp $
 */
public class DefaultindicationsconfTreeDialog extends
     ...
     */
    public DefaultindicationsconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultindicationsconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultindicationsconfTreeDialog(Object data) {
        super(data);
        initTree(data);
