...
/**
 * <p>
 * SimplezaptelconfTreePanel , ein tree panel das eine Objekt grupppe des Models
 * mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimplezaptelconfTreePanel.java,v 1.4
 *          2006/01/06 19:04:06 urs Exp $
 */
public class SimplezaptelconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimplezaptelconfTreePanel() throws HeadlessException {
        super();
    }
