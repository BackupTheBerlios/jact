...
import com.useit.jact.io.zaptelconf.ConfReaderImpl;
import com.useit.jact.io.zaptelconf.ConfWriterImpl;
import com.useit.jact.io.zaptelconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultzaptelconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultzaptelconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:34 urs Exp $
 */
public class DefaultzaptelconfTreeDialog extends
     ...
     */
    public DefaultzaptelconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultzaptelconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultzaptelconfTreeDialog(Object data) {
        super(data);
        initTree(data);
