...
import com.useit.jact.io.zapataconf.ConfReaderImpl;
import com.useit.jact.io.zapataconf.ConfWriterImpl;
import com.useit.jact.io.zapataconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultzapataconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultzapataconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:36 urs Exp $
 */
public class DefaultzapataconfTreeDialog extends
     ...
     */
    public DefaultzapataconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultzapataconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultzapataconfTreeDialog(Object data) {
        super(data);
        initTree(data);
