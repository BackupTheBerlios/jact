...
import com.useit.jact.io.featureconf.ConfReaderImpl;
import com.useit.jact.io.featureconf.ConfWriterImpl;
import com.useit.jact.io.featureconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultfeatureconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultfeatureconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:46 urs Exp $
 */
public class DefaultfeatureconfTreeDialog extends
     ...
     */
    public DefaultfeatureconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultfeatureconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultfeatureconfTreeDialog(Object data) {
        super(data);
        initTree(data);
