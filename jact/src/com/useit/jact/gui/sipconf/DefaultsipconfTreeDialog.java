...
import com.useit.jact.io.sipconf.ConfReaderImpl;
import com.useit.jact.io.sipconf.ConfWriterImpl;
import com.useit.jact.io.sipconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultsipconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultsipconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:33 urs Exp $
 */
public class DefaultsipconfTreeDialog extends
     ...
     */
    public DefaultsipconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultsipconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultsipconfTreeDialog(Object data) {
        super(data);
        initTree(data);
