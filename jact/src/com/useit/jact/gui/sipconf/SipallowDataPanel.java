 ...
 * SipallowDataPanel
 * </p>
 * Created : Thu Sep 08 19:35:43 CEST 2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SipallowDataPanel.java,v 1.4 2005/09/20
 *          14:01:52 urs Exp $
 */
public class SipallowDataPanel extends SimpleDataObjectPanel {
    protected Sipallow dataObject;

    // protected SipallowChecker dataChecker;

    /**
     * initalisiert die Resourcen alleine This is the default constructor
     */
    public SipallowDataPanel() {
        super();
     ...
     * SipallowCheckerImpl(resBundel); //abstractDataChecker = dataChecker;
     * 
     ...
     * @param Sipallow
     */
    public void setDataObject(Object aSipallow) {
        // abstractdataObject = (AbstractConfigObject) aSipallow;
        setDataObject((Sipallow) aSipallow);
        // dataObject = aSipallow;
        // setConfigToWidget();
    }
     ...
     * @param Sipallow
     */
    public void setDataObject(Sipallow aSipallow) {
        // abstractdataObject = (AbstractConfigObject) aSipallow;
        dataObject = aSipallow;
        setConfigToWidget();
    }
