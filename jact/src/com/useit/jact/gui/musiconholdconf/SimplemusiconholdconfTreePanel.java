...
/**
 * <p>
 * SimplemusiconholdconfTreePanel , ein tree panel das eine Objekt grupppe des
 * Models mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimplemusiconholdconfTreePanel.java,v 1.3
 *          2006/01/06 19:04:07 urs Exp $
 */
public class SimplemusiconholdconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimplemusiconholdconfTreePanel() throws HeadlessException {
        super();
    }
