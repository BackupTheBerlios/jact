...
import com.useit.jact.io.musiconholdconf.ConfReaderImpl;
import com.useit.jact.io.musiconholdconf.ConfWriterImpl;
import com.useit.jact.io.musiconholdconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultmusiconholdconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultmusiconholdconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:42 urs Exp $
 */
public class DefaultmusiconholdconfTreeDialog extends
     ...
     */
    public DefaultmusiconholdconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultmusiconholdconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultmusiconholdconfTreeDialog(Object data) {
        super(data);
        initTree(data);
