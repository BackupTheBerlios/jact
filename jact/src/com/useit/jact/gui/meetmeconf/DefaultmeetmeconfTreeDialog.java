...
import com.useit.jact.io.meetmeconf.ConfReaderImpl;
import com.useit.jact.io.meetmeconf.ConfWriterImpl;
import com.useit.jact.io.meetmeconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultmeetmeconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultmeetmeconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:34 urs Exp $
 */
public class DefaultmeetmeconfTreeDialog extends
     ...
     */
    public DefaultmeetmeconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultmeetmeconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultmeetmeconfTreeDialog(Object data) {
        super(data);
        initTree(data);
