...
import com.useit.jact.io.managerconf.ConfReaderImpl;
import com.useit.jact.io.managerconf.ConfWriterImpl;
import com.useit.jact.io.managerconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultmanagerconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultmanagerconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:33 urs Exp $
 */
public class DefaultmanagerconfTreeDialog extends
     ...
     */
    public DefaultmanagerconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultmanagerconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultmanagerconfTreeDialog(Object data) {
        super(data);
        initTree(data);
