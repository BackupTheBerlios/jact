...
/**
 * <p>
 * IaxregisterDataPanel
 * </p>
 * Created : Thu Dec 29 11:59:34 CET 2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: IaxregisterDataPanel.java,v 1.5 2005/12/29
 *          19:14:16 urs Exp $
 */
public class IaxregisterDataPanel extends SimpleDataObjectPanel {
    protected Iaxregister dataObject;

    // protected IaxregisterChecker dataChecker;

    /**
     * initalisiert die Resourcen alleine This is the default constructor
     */
    public IaxregisterDataPanel() {
        super();
     ...
     * IaxregisterCheckerImpl(resBundel); //abstractDataChecker = dataChecker;
     * 
     * Object[] array = { fStringTextFielduser, fStringTextFieldauthuser,
     * fStringTextFieldsecret, fStringTextFieldhost, fIntegerTextFieldport,
     * fStringTextFieldextension, }; dataChecker.initChecker(array); }
     * 
     */
    ...
    public void initActions() {
        ...
        fStringTextFieldauthuser.getDocument().addDocumentListener(
                textChangeAct);
        ...
        fStringTextFieldextension.getDocument().addDocumentListener(
                textChangeAct);
     ...
     * @param Iaxregister
     */
    public void setDataObject(Object aIaxregister) {
        // abstractdataObject = (AbstractConfigObject) aIaxregister;
        setDataObject((Iaxregister) aIaxregister);
        // dataObject = aIaxregister;
        // setConfigToWidget();
    }
     ...
     * @param Iaxregister
     */
    public void setDataObject(Iaxregister aIaxregister) {
        // abstractdataObject = (AbstractConfigObject) aIaxregister;
        dataObject = aIaxregister;
        setConfigToWidget();
    }
    ...
    public StringTextField getStringTextFielduser() {
        if (fStringTextFielduser == null) {
            try {
                ...
                fStringTextFielduser.setPreferredSize(new java.awt.Dimension(
                        150, 20)); // Generated
    ...
    protected javax.swing.JLabel getJLabeluser() {
        if (fJLabeluser == null) {
            try {
                ...
                fJLabeluser.setText(resBundel
                        .getString("res_struserDisplayName")); // Generated
                fJLabeluser.setToolTipText(resBundel
                        .getString("res_struserDescription")); // Generated
            } catch (java.lang.Throwable e) {
                e.printStackTrace();
            }
        }
    ...
    protected javax.swing.JLabel getJLabelauthuser() {
        if (fJLabelauthuser == null) {
            try {
                ...
                fJLabelauthuser.setText(resBundel
                        .getString("res_strauthuserDisplayName")); // Generated
                fJLabelauthuser.setToolTipText(resBundel
                        .getString("res_strauthuserDescription")); // Generated
            } catch (java.lang.Throwable e) {
                e.printStackTrace();
            }
        }
    ...
    protected javax.swing.JLabel getJLabelextension() {
        if (fJLabelextension == null) {
            try {
                ...
                fJLabelextension.setText(resBundel
                        .getString("res_strextensionDisplayName")); // Generated
                fJLabelextension.setToolTipText(resBundel
                        .getString("res_strextensionDescription")); // Generated
            } catch (java.lang.Throwable e) {
                e.printStackTrace();
            }
        }
