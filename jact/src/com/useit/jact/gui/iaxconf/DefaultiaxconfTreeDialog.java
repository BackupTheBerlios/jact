...
import com.useit.jact.io.iaxconf.ConfWriterImpl;
import com.useit.jact.io.iaxconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultiaxconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultiaxconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:35 urs Exp $
 */
public class DefaultiaxconfTreeDialog extends
     ...
     */
    public DefaultiaxconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultiaxconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultiaxconfTreeDialog(Object data) {
        super(data);
        initTree(data);
