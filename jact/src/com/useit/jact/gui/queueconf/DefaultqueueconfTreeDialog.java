...
import com.useit.jact.io.queueconf.ConfReaderImpl;
import com.useit.jact.io.queueconf.ConfWriterImpl;
import com.useit.jact.io.queueconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultqueueconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultqueueconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:46 urs Exp $
 */
public class DefaultqueueconfTreeDialog extends
     ...
     */
    public DefaultqueueconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultqueueconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultqueueconfTreeDialog(Object data) {
        super(data);
        initTree(data);
