...
/**
 * <p>
 * SimplequeueconfTreePanel , ein tree panel das eine Objekt grupppe des Models
 * mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimplequeueconfTreePanel.java,v 1.3
 *          2006/01/06 19:04:11 urs Exp $
 */
public class SimplequeueconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimplequeueconfTreePanel() throws HeadlessException {
        super();
    }
