...
import com.useit.jact.io.extensionconf.ConfWriterImpl;
import com.useit.jact.io.extensionconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultextensionconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultextensionconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:36 urs Exp $
 */
public class DefaultextensionconfTreeDialog extends
     ...
     */
    public DefaultextensionconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultextensionconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultextensionconfTreeDialog(Object data) {
        super(data);
        initTree(data);
