...
/**
 * <p>
 * SimpleextensionconfTreePanel , ein tree panel das eine Objekt grupppe des
 * Models mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimpleextensionconfTreePanel.java,v 1.4
 *          2006/01/06 19:04:07 urs Exp $
 */
public class SimpleextensionconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimpleextensionconfTreePanel() throws HeadlessException {
        super();
    }
