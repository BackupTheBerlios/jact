 ...
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: PbxApplicationTextField.java,v 1.1 2005/12/29
 *          19:14:29 urs Exp $
 */
public class PbxApplicationTextField extends JPanel {
    private javax.swing.JButton jButton = null;

    private javax.swing.JTextField jTextField = null;

    public PbxApplicationTextField() {
        super();
        initialize();
    }

    public PbxApplicationTextField(boolean arg0) {
        super(arg0);
        initialize();
    }

    public PbxApplicationTextField(LayoutManager arg0, boolean arg1) {
        super(arg0, arg1);
        initialize();
    }

    public PbxApplicationTextField(LayoutManager arg0) {
        super(arg0);
        initialize();
    }

    public void setValue(PbxApplication data) {
        if (data == null)
    ...
    public PbxApplication getValue() {
        return new PbxApplication(jTextField.getText());
    }
    ...
    private void initActions() {
        jButton.setAction(new ActionEditApplication());
     ...
     * @author urs
     */
    private class ActionEditApplication extends AbstractAction {
        public ActionEditApplication() {
            super();
            putValue(NAME, "...");
            putValue(ACTION_COMMAND_KEY, "ActionEditApplication");
