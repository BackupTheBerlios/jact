...
/**
 * <p>
 * EnumSetTextFieldMCardOption
 * </p>
 * Created : 05.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: EnumSetTextFieldMCardOption.java,v 1.4
 *          2005/12/25 18:09:56 urs Exp $
 */
public class EnumSetTextFieldMCardOption extends AbstractEnumSetTextField {

    /**
     * 
     */
    public EnumSetTextFieldMCardOption() {
        super();
    }

    // public void setValue(MCardOption data){
    // senum = data;
    // if(senum==null) senum = new MCardOption("");
    // setSelectedIndex(senum.getEnumInt());
    // }
    public MCardOptionSet getValue() {
        if (aEnumSet == null)
            return null;
        // senum.setEnumint(getSelectedIndex());
        // if(senum.getEnumInt()==-1)return null;

        return (MCardOptionSet) aEnumSet;
    }
