 ...
 *          19:14:29 urs Exp $
 */
public class ExtensionWidget extends JPanel {
    private javax.swing.JButton jButton = null;

    private javax.swing.JTextField jTextField = null;

    public ExtensionWidget() {
        super();
        initialize();
    }

    public ExtensionWidget(boolean arg0) {
        super(arg0);
        initialize();
    }

    public ExtensionWidget(LayoutManager arg0, boolean arg1) {
        super(arg0, arg1);
        initialize();
    }

    public ExtensionWidget(LayoutManager arg0) {
        super(arg0);
        initialize();
    }

    public void setValue(AbstractExtension data) {
        if (data == null)
    ...
    public AbstractExtension getValue() {
        return new AbstractExtension(jTextField.getText());
    }
