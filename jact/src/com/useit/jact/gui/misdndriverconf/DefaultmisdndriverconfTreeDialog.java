...
import com.useit.jact.io.misdndriverconf.ConfReaderImpl;
import com.useit.jact.io.misdndriverconf.ConfWriterImpl;
import com.useit.jact.io.misdndriverconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultmisdndriverconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultmisdndriverconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:36 urs Exp $
 */
public class DefaultmisdndriverconfTreeDialog extends
     ...
     */
    public DefaultmisdndriverconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultmisdndriverconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultmisdndriverconfTreeDialog(Object data) {
        super(data);
        initTree(data);
