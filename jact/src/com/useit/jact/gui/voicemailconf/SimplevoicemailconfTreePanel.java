...
/**
 * <p>
 * SimplevoicemailconfTreePanel , ein tree panel das eine Objekt grupppe des
 * Models mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimplevoicemailconfTreePanel.java,v 1.3
 *          2006/01/06 19:04:05 urs Exp $
 */
public class SimplevoicemailconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimplevoicemailconfTreePanel() throws HeadlessException {
        super();
    }
