...
import com.useit.jact.io.voicemailconf.ConfReaderImpl;
import com.useit.jact.io.voicemailconf.ConfWriterImpl;
import com.useit.jact.io.voicemailconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultvoicemailconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultvoicemailconfTreeDialog.java,v 1.7
 *          2006/01/09 10:17:33 urs Exp $
 */
public class DefaultvoicemailconfTreeDialog extends
     ...
     */
    public DefaultvoicemailconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultvoicemailconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultvoicemailconfTreeDialog(Object data) {
        super(data);
        initTree(data);
