...
/**
 * <p>
 * SimpleagentconfTreePanel , ein tree panel das eine Objekt grupppe des Models
 * mit den datenpanels zusammen anzeigt.
 * </p>
 * Created : 07.09.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: SimpleagentconfTreePanel.java,v 1.3
 *          2006/01/06 19:04:07 urs Exp $
 */
public class SimpleagentconfTreePanel extends AbstractSimpleTreePanel {

    /**
     * @throws HeadlessException
     */
    public SimpleagentconfTreePanel() throws HeadlessException {
        super();
    }
