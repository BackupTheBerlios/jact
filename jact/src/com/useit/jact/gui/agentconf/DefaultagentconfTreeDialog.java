...
import com.useit.jact.io.agentconf.ConfReaderImpl;
import com.useit.jact.io.agentconf.ConfWriterImpl;
import com.useit.jact.io.agentconf.XmlHandlerImpl;

/**
 * <p>
 * DefaultagentconfTreeDialog
 * </p>
 * Created : 12.08.2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: DefaultagentconfTreeDialog.java,v 1.5
 *          2006/01/09 10:17:35 urs Exp $
 */
public class DefaultagentconfTreeDialog extends
     ...
     */
    public DefaultagentconfTreeDialog(Dialog owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @throws HeadlessException
     */
    public DefaultagentconfTreeDialog(Frame owner, Object data)
            throws HeadlessException {
        super(owner, data);
        initTree(data);
    }
     ...
     * @param data
     */
    public DefaultagentconfTreeDialog(Object data) {
        super(data);
        initTree(data);
