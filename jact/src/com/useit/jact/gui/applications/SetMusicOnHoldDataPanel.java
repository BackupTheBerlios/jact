...
import com.useit.jact.model.applications.SetMusicOnHold;

/**
 * <p>
 * SetMusicOnHoldDataPanel
 * </p>
 * Created : Mon Jul 10 18:06:31 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: SetMusicOnHoldDataPanel.java,v 1.1 2008/06/24 20:44:55 urszeidler Exp $
 */
public class SetMusicOnHoldDataPanel extends SimpleDataObjectPanel{
	protected SetMusicOnHold dataObject;
	//protected SetMusicOnHoldChecker dataChecker;
	 ...
	 */
	public SetMusicOnHoldDataPanel() {
		super();
...
/**	
	private void initDatachecker() {
		//dataChecker = new SetMusicOnHoldCheckerImpl(resBundel);
...
// get the Data
	 ...
	 * @param SetMusicOnHold
	 */
	public void setDataObject(Object aSetMusicOnHold) {
	    //abstractdataObject = (AbstractConfigObject) aSetMusicOnHold;
		setDataObject((SetMusicOnHold) aSetMusicOnHold);
		//dataObject = aSetMusicOnHold;
		//setConfigToWidget();
	}
	 ...
	 * @param SetMusicOnHold
	 */
	public void setDataObject(SetMusicOnHold aSetMusicOnHold) {
	    //abstractdataObject = (AbstractConfigObject) aSetMusicOnHold;
		dataObject = aSetMusicOnHold;
		setConfigToWidget();
	}
