...
import com.useit.jact.model.applications.SayUnixTime;

/**
 * <p>
 * SayUnixTimeDataPanel
 * </p>
 * Created : Mon Jul 10 18:05:58 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: SayUnixTimeDataPanel.java,v 1.1 2008/06/24 20:44:54 urszeidler Exp $
 */
public class SayUnixTimeDataPanel extends SimpleDataObjectPanel{
	protected SayUnixTime dataObject;
	//protected SayUnixTimeChecker dataChecker;
...
/**	
	private void initDatachecker() {
		//dataChecker = new SayUnixTimeCheckerImpl(resBundel);
...
// get the Data
	 ...
	 * @param SayUnixTime
	 */
	public void setDataObject(Object aSayUnixTime) {
	    //abstractdataObject = (AbstractConfigObject) aSayUnixTime;
		setDataObject((SayUnixTime) aSayUnixTime);
		//dataObject = aSayUnixTime;
		//setConfigToWidget();
	}
	 ...
	 * @param SayUnixTime
	 */
	public void setDataObject(SayUnixTime aSayUnixTime) {
	    //abstractdataObject = (AbstractConfigObject) aSayUnixTime;
		dataObject = aSayUnixTime;
		setConfigToWidget();
	}
