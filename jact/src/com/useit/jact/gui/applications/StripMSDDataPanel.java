...
import com.useit.jact.model.applications.StripMSD;

/**
 * <p>
 * StripMSDDataPanel
 * </p>
 * Created : Mon Jul 10 18:07:14 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: StripMSDDataPanel.java,v 1.1 2008/06/24 20:44:54 urszeidler Exp $
 */
public class StripMSDDataPanel extends SimpleDataObjectPanel{
	protected StripMSD dataObject;
	//protected StripMSDChecker dataChecker;
...
/**	
	private void initDatachecker() {
		//dataChecker = new StripMSDCheckerImpl(resBundel);
...
// get the Data
	 ...
	 * @param StripMSD
	 */
	public void setDataObject(Object aStripMSD) {
	    //abstractdataObject = (AbstractConfigObject) aStripMSD;
		setDataObject((StripMSD) aStripMSD);
		//dataObject = aStripMSD;
		//setConfigToWidget();
	}
	 ...
	 * @param StripMSD
	 */
	public void setDataObject(StripMSD aStripMSD) {
	    //abstractdataObject = (AbstractConfigObject) aStripMSD;
		dataObject = aStripMSD;
		setConfigToWidget();
	}
