...
import com.useit.jact.model.applications.PauseQueueMember;

/**
 * <p>
 * PauseQueueMemberDataPanel
 * </p>
 * Created : Mon Jul 10 18:05:37 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: PauseQueueMemberDataPanel.java,v 1.1 2008/06/24 20:44:55 urszeidler Exp $
 */
public class PauseQueueMemberDataPanel extends SimpleDataObjectPanel{
	protected PauseQueueMember dataObject;
	//protected PauseQueueMemberChecker dataChecker;
	 ...
	 */
	public PauseQueueMemberDataPanel() {
		super();
...
/**	
	private void initDatachecker() {
		//dataChecker = new PauseQueueMemberCheckerImpl(resBundel);
...
// get the Data
	 ...
	 * @param PauseQueueMember
	 */
	public void setDataObject(Object aPauseQueueMember) {
	    //abstractdataObject = (AbstractConfigObject) aPauseQueueMember;
		setDataObject((PauseQueueMember) aPauseQueueMember);
		//dataObject = aPauseQueueMember;
		//setConfigToWidget();
	}
	 ...
	 * @param PauseQueueMember
	 */
	public void setDataObject(PauseQueueMember aPauseQueueMember) {
	    //abstractdataObject = (AbstractConfigObject) aPauseQueueMember;
		dataObject = aPauseQueueMember;
		setConfigToWidget();
	}
