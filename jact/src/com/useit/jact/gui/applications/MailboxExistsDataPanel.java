...
import com.useit.jact.model.applications.MailboxExists;

/**
 * <p>
 * MailboxExistsDataPanel
 * </p>
 * Created : Mon Jul 10 18:07:36 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: MailboxExistsDataPanel.java,v 1.1 2008/06/24 20:44:54 urszeidler Exp $
 */
public class MailboxExistsDataPanel extends SimpleDataObjectPanel{
	protected MailboxExists dataObject;
	//protected MailboxExistsChecker dataChecker;
...
/**	
	private void initDatachecker() {
		//dataChecker = new MailboxExistsCheckerImpl(resBundel);
...
// get the Data
	 ...
	 * @param MailboxExists
	 */
	public void setDataObject(Object aMailboxExists) {
	    //abstractdataObject = (AbstractConfigObject) aMailboxExists;
		setDataObject((MailboxExists) aMailboxExists);
		//dataObject = aMailboxExists;
		//setConfigToWidget();
	}
	 ...
	 * @param MailboxExists
	 */
	public void setDataObject(MailboxExists aMailboxExists) {
	    //abstractdataObject = (AbstractConfigObject) aMailboxExists;
		dataObject = aMailboxExists;
		setConfigToWidget();
	}
