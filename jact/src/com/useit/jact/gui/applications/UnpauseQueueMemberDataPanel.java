...
import com.useit.jact.model.applications.UnpauseQueueMember;

/**
 * <p>
 * UnpauseQueueMemberDataPanel
 * </p>
 * Created : Mon Jul 10 18:07:26 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: UnpauseQueueMemberDataPanel.java,v 1.1 2008/06/24 20:44:55 urszeidler Exp $
 */
public class UnpauseQueueMemberDataPanel extends SimpleDataObjectPanel{
	protected UnpauseQueueMember dataObject;
	//protected UnpauseQueueMemberChecker dataChecker;
	 ...
	 */
	public UnpauseQueueMemberDataPanel() {
		super();
...
/**	
	private void initDatachecker() {
		//dataChecker = new UnpauseQueueMemberCheckerImpl(resBundel);
...
// get the Data
	 ...
	 * @param UnpauseQueueMember
	 */
	public void setDataObject(Object aUnpauseQueueMember) {
	    //abstractdataObject = (AbstractConfigObject) aUnpauseQueueMember;
		setDataObject((UnpauseQueueMember) aUnpauseQueueMember);
		//dataObject = aUnpauseQueueMember;
		//setConfigToWidget();
	}
	 ...
	 * @param UnpauseQueueMember
	 */
	public void setDataObject(UnpauseQueueMember aUnpauseQueueMember) {
	    //abstractdataObject = (AbstractConfigObject) aUnpauseQueueMember;
		dataObject = aUnpauseQueueMember;
		setConfigToWidget();
	}
