 ...
 * ToneDefinitionsMap
 * </p>
 * Created : Tue Dec 27 15:21:35 CET 2005
 * 
 * @author urs
 * @version $Revision: 1.1 $, $Id: ToneDefinitionsMap.java,v 1.4 2005/12/29
 *          19:14:17 urs Exp $
 */
public class ToneDefinitionsMap extends AbstractObjectMap {
    ...
    /**
     * einfacher Konstruktor für ToneDefinitionsMap
     */
    public ToneDefinitionsMap() {
        super();
    ...
    public ToneDefinitions newToneDefinitions() {
        ToneDefinitions nToneDefinitions = new ToneDefinitionsImpl();
        return nToneDefinitions;
    }
    ...
    public void addObject(Object object) {
        putToneDefinitions((ToneDefinitions) object);
     ...
     *             <tt>null</tt> keys.
     */
    public ToneDefinitions get(String aKey) {
        return (ToneDefinitions) this.itsMap.get(aKey);
    }
     ...
     */
    public ToneDefinitions put(String aKey, ToneDefinitions aValue) {
        return (ToneDefinitions) this.itsMap.put(aKey, aValue);
    }

    /**
     * das selbe put ohne Key (wird automatisch gesetz)
     */
    public ToneDefinitions putToneDefinitions(ToneDefinitions aValue) {
        return (ToneDefinitions) this.itsMap.put(aValue.toString(), aValue);
    }

    /**
     * remove ohne Key (wird automatisch gesetz)
     */
    public ToneDefinitions removeToneDefinitions(ToneDefinitions aValue) {
        return (ToneDefinitions) this.itsMap.remove(aValue.toString());
    }
     ...
     *             the specified key or value is <tt>null</tt>.
     */
    public void putAllToneDefinitions(Map aMap) {
    ...
    public ToneDefinitions remove(String aKey) {
        return (ToneDefinitions) this.itsMap.remove(aKey);
    }
