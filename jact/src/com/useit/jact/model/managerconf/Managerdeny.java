 ...
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: Managerdeny.java,v 1.1 2008/06/24 20:45:13 urszeidler Exp $
 */
 public  class Managerdeny extends AbstractSimpleDataClass implements IManagerdeny{
	// --------------- Konstruktor ---------------------
	/**
	...
	**/
	public Managerdeny( String avalue){
		super();
	 ...
	 * @param object
	 */
	public void assignTo(Managerdeny object){
