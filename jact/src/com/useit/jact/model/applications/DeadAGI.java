 ...
 * </p>
 * Created : Sun Jul 09 18:49:08 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: DeadAGI.java,v 1.1 2008/06/24 20:44:56 urszeidler Exp $
 */
 public  class DeadAGI extends PbxApplication implements IDeadAGI{
	protected boolean changed;
	
	// --------------- Konstruktor ---------------------
	/**
	* einfacher Konstruktor für DeadAGI
	**/
	public DeadAGI(){
		super();
	 ...
	 * @param object
	 */
	public void assignTo(DeadAGI object){
