 ...
 * </p>
 * Created : Sun Jul 09 18:49:39 CEST 2006
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: RemoveQueueMember.java,v 1.1 2008/06/24 20:44:59 urszeidler Exp $
 */
 public  class RemoveQueueMember extends PbxApplication implements IRemoveQueueMember{
	...
	**/
	public RemoveQueueMember( String aqueuename, String ainterface_){
		super();
	 ...
	 * @param object
	 */
	public void assignTo(RemoveQueueMember object){
