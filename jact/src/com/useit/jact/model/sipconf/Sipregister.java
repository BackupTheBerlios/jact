 ...
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: Sipregister.java,v 1.1 2008/06/24 20:45:13 urszeidler Exp $
 */
 public  class Sipregister extends AbstractSimpleDataClass implements ISipregister{
	// --------------- Konstruktor ---------------------
	/**
	...
	**/
	public Sipregister( String auser, String aauthuser, String asecret, String ahost, Integer aport, String aextension){
		super();
	 ...
	 * @param object
	 */
	public void assignTo(Sipregister object){
