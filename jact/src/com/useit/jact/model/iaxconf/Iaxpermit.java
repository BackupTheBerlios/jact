 ...
 *
 * @author urs
 * @version $Revision: 1.1 $, $Id: Iaxpermit.java,v 1.1 2008/06/24 20:45:11 urszeidler Exp $
 */
 public  class Iaxpermit extends AbstractSimpleDataClass implements IIaxpermit{
	// --------------- Konstruktor ---------------------
	/**
	...
	**/
	public Iaxpermit( String avalue){
		super();
	 ...
	 * @param object
	 */
	public void assignTo(Iaxpermit object){
